...
import { ShopIcon, StarIcon, GameIcon, MenuIcon, PawIcon } from '../KawaiiIcons';
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 pb-6 px-5">
        ...
        <div className="flex items-center justify-center gap-3 px-2">
          ...
          <KawaiiButton 
            ...
            onClick={onGameClick}
            className="flex-1 max-w-[110px] !h-[48px] !min-h-[48px] !text-[14px] !font-semibold hover:scale-[1.05] active:scale-95 transition-all duration-200 shadow-[0_0_20px_rgba(200,184,255,0.4)] hover:shadow-[0_0_28px_rgba(200,184,255,0.6)] animate-pulse"
