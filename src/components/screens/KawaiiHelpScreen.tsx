...
const faqItems: FAQItem[] = [
  ...
  {
    question: 'How to connect Google Fit?',
    answer: 'Go to Settings → Permissions and enable Google Fit. This allows Papi Steps to track your daily walking activity automatically. Make sure to allow the necessary permissions in your Android settings! 📱',
    emoji: '❤️'
  },
  {
